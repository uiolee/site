...
Above setup will inject `APlayer.min.css` (`<link>` tag) to the `</head>` of any page which layout is `music`, and `APlayer.min.js` (`<script>` tag) to the `</body>` of those pages. Also, `jquery.js` (`<script>` tag) will be injected to `</body>` of every page generated. Also, `jquery.js` (`<script>` tag) will be injected to `</body>` of every page generated. Also, `jquery.js` (`<script>` tag) will be injected to `</body>` of every page generated.
