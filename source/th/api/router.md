...
วิธี `get` จะส่งกลับผลที่เป็น [Stream][] code ต่อไปเป็นตัวอย่างการบ่งบอก path ไปถึงหน้งเว็บเฉพาะ For example, to save the path data to a specified destination: For example, to save the path data to a specified destination:
