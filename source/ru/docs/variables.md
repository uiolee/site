...
| `page.date`        | Article created date                                                                             | Дата создания страницы (Объект [Moment.js][])     |
| `page.updated`     | Article last updated date                                                                        | Дата последнего обновления (Объект [Moment.js][]) |
