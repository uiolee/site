...
4. Check what version of Node.js you are using on your local machine with `node --version`. Make a note of the major version (e.g., `v16.y.z`) 给主要版本注解(例如， `v16.y.z`
...
1. Go to **Settings** > **General** > **Advanced** > **Change path**. Change the value to a name, so the website is available at <b>username.gitlab.io/*repository*</b>. It can be any name, like *blog* or *hexo*. 将值更改为名称，所以网站可在 <b>username.gitlab.io/*repository*</b> 查阅。 It can be any name, like *blog* or *hexo*.
